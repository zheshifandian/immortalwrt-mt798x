...
$(eval $(call SetupHostCommand,protoc-c,Please install 'protobuf-c-compiler', \
	protoc-c --version </dev/null))

$(eval $(call SetupHostCommand,re2c,Please install 're2c', \
	re2c --version </dev/null))
